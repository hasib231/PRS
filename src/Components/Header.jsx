...
const Header = () => {
  return (
    <>
      <div className="min-h-full rounded-full">
                  ...
                  <div className="flex items-center">
                    <div className="flex-shrink-0 ">
                      ...
                      <MovingComponent
                        ...
                        iteration="1"
                        fillMode="none"
                        className="text-gray-300 items-center tracking-widest font-semibold pb-1 m-1 ml-0 "
                      >
                        <span className="text-lime-300">Product</span>
